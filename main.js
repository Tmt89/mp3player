...
const app = {
  ...
  currentindex: 0,
    songs: [
        { name: 'radio1',
          singer: 'Độ mixi',
          path: './songs/radio1.mp3',  
          image: './image/avatar.jpg'  
        },
        { name: 'radio2',
          singer: 'Độ mixi',
          path: './songs/radio2.mp3',  
          image: './image/avatar.jpg'  
        },
        { name: 'radio3',
          singer: 'Độ mixi',
          path: './songs/radio3.mp3',  
          image: './image/avatar.jpg'  
        },
        { name: 'radio4',
          singer: 'Độ mixi',
          path: './songs/radio4.mp3',  
          image: './image/avatar.jpg'  
        },
        { name: 'radio5',
          singer: 'Độ mixi',
          path: './songs/radio5.mp3',  
          image: './image/avatar.jpg'  
        },
        { name: 'radio6',
          singer: 'Độ mixi',
          path: './songs/radio6.mp3',  
          image: './image/avatar.jpg'  
        },
        { name: 'radio7',
          singer: 'Độ mixi',
          path: './songs/radio7.mp3',  
          image: './image/avatar.jpg'  
        },
        { name: 'Một triệu like',
          singer: 'Đen vâu',
          path: './songs/1millionlike.mp3',  
          image: './image/1millionlike.jpg'  
        },
        { name: 'Không thích',
          singer: 'Low G',
          path: './songs/dontlike.mp3',  
          image: './image/dontlike.jpg'  
        },
        { name: 'Lối nhỏ',
          singer: 'Đen vâu',
          path: './songs/smallway.mp3',  
          image: './image/smallway.jpg'  
        },
        { name: 'Cảm ơn',
          singer: 'Đen vâu',
          path: './songs/camon.mp3',  
